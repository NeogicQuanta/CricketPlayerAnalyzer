#!/usr/bin/env python3
"""
Cricket Dashboard API Server
Flask web application that serves cricket player data via JSON API
"""
...
if __name__ == "__main__":
    print("🏏 Starting Cricket Dashboard Server...")
    print("📊 Server will be available at: http://localhost:5000")
    print("🔍 Enter any player ID to get dynamic cricket statistics!")
    print("\nExample Player IDs:")
